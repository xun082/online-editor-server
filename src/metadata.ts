...
export default async () => {
  ...
  return {
    '@nestjs/swagger': {
      models: [
        [
          import('./api/user/schema/user.schema'),
          {
            User: {
        ...
        [
          import('./api/login/dto/login.dto'),
          {
            EmailLoginDto: {
              email: { required: true, type: () => String },
        ...
        [
          import('./base/pagination.dto'),
          {
            ...
            PaginationOption: {
              page: { required: true, type: () => Number, minimum: 0 },
              limit: {
                required: true,
                type: () => Number,
                minimum: 1,
      ...
      controllers: [
        [
          ...
          { UserController: { getUserInfo: { type: Object } } }
        ],
        [
        ...
        [
          import('./api/login/login.controller'),
